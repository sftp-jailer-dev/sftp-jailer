...
// Phase 4 plan 04-03 bumped to 3 with 003_user_ips.sql (FW-08 derived cache).
// Phase 9 plan 09-02 bumped to 4 with 004_add_dedup_index.sql (LOG-10
// covering index for dedup queries).
