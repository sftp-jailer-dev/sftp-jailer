...
// TestPwauthdisable_submitDoneMsg_PID0Fallback_does_not_render_kill_minus_9_zero
...
func TestPwauthdisable_submitDoneMsg_PID0Fallback_does_not_render_kill_minus_9_zero(t *testing.T) {
	t.Parallel()
	m := pwauthdisable.New(nil, nil, testChrootRoot, pwauthdisable.ActionDisable)
	m.SetPhaseSubmittingForTest()
	m.SetCancelFnForTest(func() {})
...
// TestPwauthdisable_submitDoneMsg_LivePID_still_renders_kill_minus_9_pid (06-05
// regression guard): when pid > 0, the verbatim D-08 copy must still appear.
func TestPwauthdisable_submitDoneMsg_LivePID_still_renders_kill_minus_9_pid(t *testing.T) {
	t.Parallel()
	m := pwauthdisable.New(nil, nil, testChrootRoot, pwauthdisable.ActionDisable)
	m.SetPhaseSubmittingForTest()
	m.SetCancelFnForTest(func() {})
	...
	hangErr := errors.New("simulated SIGKILL hang")
	_, _ = m.FeedSubmitDoneForTestWithPID(hangErr, 99001)
